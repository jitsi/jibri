...
import org.jitsi.jibri.toLegacyJibriStatus
import org.jitsi.jibri.util.RefreshingProperty
import org.jitsi.jibri.util.retryWithBackoff
...
class WebhookClient(
    ...
    private val jwt: String? by RefreshingProperty(jwtInfo?.ttl?.minus(5.mins) ?: INFINITE) {
        jwtInfo?.let {
            Jwts.builder()
